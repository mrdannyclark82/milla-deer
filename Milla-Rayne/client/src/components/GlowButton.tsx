...
const GlowButton = React.forwardRef<HTMLButtonElement, GlowButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      purple:
        'bg-gradient-to-br from-cyber-purple to-purple-700 text-white hover:from-cyber-purple hover:to-purple-800 focus-visible:ring-cyber-purple',
      default:
    ...
    const glowStyles = glow
      ? {
          ...
          purple:
            'shadow-[0_0_10px_rgba(124,58,237,0.5)] hover:shadow-[0_0_20px_rgba(124,58,237,0.8)]',
          default: '',
        }
