  ...
  const handleFaceClick = (area: string, e: React.MouseEvent) => {
    ...
    switch (area) {
      ...
      case 'mouth':
        ...
        setTimeout(
          () => setFaceState((prev) => ({ ...prev, mouthOpen: 0 })),
          1000
        );
        break;
      case 'forehead':
        ...
        setTimeout(
          () => setFaceState((prev) => ({ ...prev, eyebrowHeight: 0 })),
          1500
        );
        break;
    }
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(160deg, transparent 20%, hsl(20, 80%, 55%) 40%, transparent 60%)',
                  clipPath: 'ellipse(85% 100% at 50% 100%)',
                }}
              />
            </div>
            ...
            <div className="absolute top-16 left-1/2 transform -translate-x-1/2 flex space-x-6">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    '0 4px 12px rgba(0,0,0,0.15), inset 0 1px 3px rgba(255,255,255,0.3)',
                }}
          ...
          <div
            className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-500 backdrop-blur-sm ${
              avatarState === 'thinking'
                ? 'bg-blue-100/90 text-blue-800 shadow-lg shadow-blue-500/20'
                : avatarState === 'responding'
                  ? 'bg-green-100/90 text-green-800 shadow-lg shadow-green-500/20'
                  : avatarState === 'listening'
                    ? 'bg-yellow-100/90 text-yellow-800 shadow-lg shadow-yellow-500/20'
