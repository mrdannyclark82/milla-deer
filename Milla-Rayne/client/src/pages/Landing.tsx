      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Milla-Rayne is an offline-first AI companion that runs on your
            phone, controls your home, and remembers everything — with zero
            cloud dependency.
          </p>
          ...
          <div className="mt-8 text-sm text-slate-500">
            ...
            <button
              onClick={startDemo}
              className="text-pink-400 hover:text-pink-300 underline cursor-pointer bg-transparent border-none p-0"
            >
              Try demo →
            </button>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              Built for power users who refuse to trade privacy for capability.
            </p>
          </div>
      ...
      <footer className="py-10 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="mailto:mrdannyclark82@gmail.com"
              className="hover:text-white transition-colors"
            >
              Contact
            </a>
