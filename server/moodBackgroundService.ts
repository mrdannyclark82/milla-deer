...
const MOOD_PROMPTS: Record<SceneMood, string> = {
  ...
  energetic:
    'vibrant dynamic cityscape, neon lights, fast motion blur, electric energy, bright bold colors, lightning strikes, explosive colors, racing streaks of light, high energy atmosphere, cyberpunk style, 4k high quality',
  romantic:
    'romantic sunset scene, warm golden hour lighting, soft pink and purple sky, couple silhouettes, heart-shaped elements, rose petals floating, candlelit ambiance, dreamy bokeh lights, tender atmosphere, 4k high quality',
  mysterious:
    'dark mysterious forest, fog rolling through trees, moonlight filtering through mist, deep shadows, ethereal glow, ancient ruins, mystical atmosphere, purple and blue tones, enigmatic scene, 4k high quality',
  playful:
    'whimsical colorful scene, rainbow colors, bubbles floating, confetti, joyful bright patterns, cartoon-style clouds, bouncing elements, fun textures, cheerful atmosphere, vibrant playful energy, 4k high quality',
};
...
export async function getMoodBackground(
  mood: SceneMood,
  forceRegenerate?: boolean
) {
  return await moodBackgroundService.getBackgroundForMood(
    mood,
    forceRegenerate
  );
}
